...
class MyTest(object):
    ...
    def get_numbers(self):
        ...
        self.driver.find_element_by_xpath('/html/body/div[3]/div[2]/div/div/div[2]/form/div/div[2]/div/div/div/div/div/input').send_keys('0')
        #it's need a clear ...
    ...
    def start_disktop_app(self):
        ...
        dlg.child_window(title="Prefix :", auto_id="TextBox2", control_type="Edit").set_text('ID')
        dlg.child_window(title="Start", auto_id="Btn_Start", control_type="Button").click()

numOfIterasions = 80
test = MyTest()
while numOfIterasions < 80 :
    try:
        test.login_process()
